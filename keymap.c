...
[_WINBASE] = LAYOUT_preonic_1x2uC(  /* Base Layer */
 /*
  ...
  KC_ESC,  SHFT_A,   CTRL_S, ALT_D, GUI_F,    KC_G,           KC_H,           GUI_J,   ALT_K,    CTRL_L,   SHSQ,          TD(QUO),\
  TD(CLS), Z_UNDO, X_REDO, KC_C,   KC_V,    KC_B,           KC_N,           KC_M,    CTRL_COMM,  SHFT_DOT,   SLASHES,   KC_RSHIFT,\
  KC_TAB, KC_LGUI ,MIRR_TAB ,NUMPAD, KC_BSPC, CTLDEL,         SFT_ENT, 		KC_SPC,  ARROWS,   FN_ESC, KC_EQUAL, CPYPST,\
...
[_MIRROR] = LAYOUT_preonic_1x2uC(  /*MIRROR*/
  KC_TAB,       KC_P,           KC_O,    KC_I,     KC_U,    KC_Y,           KC_MS_ACCEL0, KC_MS_BTN1,	KC_MS_UP,  KC_MS_BTN2, KC_Q,KC_BSLASH, \
  TO(_WINBASE), TD(SCL),        KC_L,    KC_K,     KC_J,    KC_H,           KC_MS_ACCEL1, KC_MS_LEFT,	KC_MS_DOWN,KC_MS_RIGHT,KC_A,TD(QUO), \
...
[_ARROWS] = LAYOUT_preonic_1x2uC(  /* RAISE - Arrows */
  ...
  _______, TD(CLS), CURLY,	 SQUAR,	    PARAN,	XXXXXXX, KC_PSCR,  KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX,   _______,\
